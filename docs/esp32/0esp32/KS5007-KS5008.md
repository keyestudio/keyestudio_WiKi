...
* [KS5007(KS5008)Keyestudio ESP32 24 in 1 Sensor Kit Arduino tutorial](https://ks5007ks5008keyestudio-esp32-arduino.readthedocs.io/en/latest/)

* [KS5007(KS5008)Keyestudio ESP32 24 in 1 Sensor Kit Python tutorial](https://ks5007ks5008keyestudio-esp32-python.readthedocs.io/en/latest/)

* [KS5007(KS5008)Keyestudio ESP32 24 in 1 Sensor Kit Arduino for Raspberry Pi tutorial](https://ks5007ks5008keyestudio-esp32-arduino-for-raspberry-pi.readthedocs.io/en/latest/)
